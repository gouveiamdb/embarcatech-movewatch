...
0x30, 0x40, 0x40, 0x45, 0x4D, 0x38, 0x00, 0x00, // ?
0x08, 0x04, 0x06, 0x02, 0x04, 0x08, 0x00, 0x00,  // ~
...
static inline uint8_t* get_char_data(char c) {
    ...
    if (c == ' ') {
        ...
        index = 63; // Ajuste conforme a posição do "!" na fonte
    }
    else if (c == '?') {
        index = 64; // Ajuste conforme a posição do "?"
    }
    else if (c == '~') {
        index = 65; // Ajuste conforme a posição do "~"
    }
    else if (c == '.') {
        index = 66; // Ajuste conforme a posição do "." na fonte
    }
